...
function VerifyEmail({set_show_verify_email,set_success,set_success_message,set_fail,set_fail_message}){
    ...
    return(
    <div style={{width:"90%",height:"90%",display:"flex",fontSize:"14px",flexDirection:"column",alignItems:"center",overflow:"scroll"}}>
        <div style={{width:"90%",marginTop:"40px",color:"rgb(30,30,30)",fontSize:"16px",display:"flex",alignItems:"center",justifyContent:"start"}}>
            <FaArrowLeft style={{cursor:"pointer"}} onClick={()=>{
                set_show_verify_email(false);
            }}/><div style={{marginLeft:"10px"}}>Verify your email account</div>
        </div>
        <div style={{width:"90%",display:"flex",marginTop:"20px",flexDirection:"column",alignItems:"center"}}>
            <div style={{width:"100%",display:"flex",flexDirection:"column",alignItems:"center"}}>
                ...
                <div style={{width:"100%",display:"flex",border:"1px solid rgb(240,240,240)",borderRadius:"10px",flexDirection:"row",alignItems:"center",justifyContent:"center"}}>
                    <div style={{width:"90%",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
                        <FaLock/>
                        <input type="text" value={ver_tok} style={{width:"80%",border:"0px"}} onChange={(e)=>{
                ...
                <div style={{width:"100%",display:"flex",flexDirection:"row",justifyContent:"end",alignItems:"center"}}>
                    <div style={{display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",backgroundColor:"orange",color:"white",borderRadius:"10px",fontSize:"12px",width:"40%",paddingTop:"10px",paddingBottom:"10px",marginTop:"10px",cursor:"pointer"}} onClick={async()=>{
                        if(ver_loading==false){
                            await make_ver();
                        }
                    }}>{ver_loading?null:<Send/>}<div>{ver_loading?"Loading...":send_token_text}</div></div>
                </div>
            </div>
        </div>
        <div style={{width:"90%",display:"flex",marginTop:"20px",marginBottom:"20px",flexDirection:"column",alignItems:"center"}}>
            ...
            }}><div>{ver1_loading?"Loading...":"VERIFY EMAIL"}</div></div>
        </div>
