...
function Business_large({prop_set_q}){
        ...
        await fetch(url,{
            ...
            body: JSON.stringify({
              ...
              //  entity_type: "nellalink_business",
                entity_featured_url: `https://nellalink.s3.eu-west-1.amazonaws.com/entity/nellalink_business/${localStorage.getItem("uuid")}/info/logo/${nw}-${encodeURIComponent(file.name.toString().replace(/\s/g,""))}`,
    ...
    return (
        <div id="large_business" style={{width:"100%",height:"85%",overflow:"scroll",flexDirection:"column",alignItems:"center",position:"relative",color:"black"}}>
            ...
            {/* ....... */}
             <div style={{width:"100%",height:`90%`,paddingTop:"20px",paddingBottom:"20px",transition:"all 0.3s linear",position:"relative",display:"flex",flexDirection:"column",alignItems:"center",overflow:"scroll",backgroundColor:"white",opacity:"1"}} onScroll={(e)=>{
