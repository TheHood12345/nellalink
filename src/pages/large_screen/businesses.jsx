        ...
        await fetch(url,{
            ...
            body: JSON.stringify({
              ...
              //  entity_type: "nellalink_business",
                entity_featured_url: `https://nellalink.s3.eu-west-1.amazonaws.com/entity/nellalink_business/${localStorage.getItem("uuid")}/info/logo/${nw}-${encodeURIComponent(file.name)}`,
