...
function Flip1(){
    ...
    return (
        <div style={{width:"100%",paddingTop:"20px",position:"relative",fontFamily:"poppins-light",fontSize:"12px",paddingBottom:"20px",position:"relative",display:"flex",paddingBottom:"20px",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
