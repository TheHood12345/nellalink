...
function Login(){
    ...
    return (
        <div style={{width:"100%",height:"100%",position:"relative",color:"rgb(100,100,100)",backgroundColor:"rgb(255,255,255)",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
            <div style={{width:"100%",height:"100%",overflow:"scroll",backgroundColor:"white",borderRadius:"10px",display:"flex",flexDirection:"column",alignItems:"center"}}>
        <h1></h1><div style={{fontFamily:"poppins-bold",width:"90%",fontSize:"28px",marginTop:"20px"}}>Welcome back!</div>
                ...
                <div style={{width:"90%",marginTop:"20px",marginBottom:"20px",backgroundColor:"white",display:"flex",flexDirection:"column",alignItems:"start"}}>
                    <div>Password</div>
                    <div style={{width:"100%",backgroundColor:"white",border:"1px solid rgb(240,240,240)",borderRadius:"10px",paddingRight:"10px",boxSizing:"border-box",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
                        <input type={eye?"text":"password"} value={password} onChange={(e)=>{
                            set_password(e.target.value)
                        }} placeholder="Enter Password" style={{width:"90%",border:"0px"}}/>
                        {eye==true?<FaEyeSlash color="gray" size={23} style={{cursor:"pointer"}} onClick={()=>{
                            set_eye(!eye);
                        }}/>:<FaEye color="gray" size={23} style={{cursor:"pointer"}} onClick={()=>{
                            set_eye(!eye);
                        }}/>}
                    </div>
                </div>
                <div style={{opacity:"1",width:"90%",backgroundColor:"#fd7e14",borderRadius:"10px",color:"white",paddingTop:"20px",paddingBottom:"20px",textAlign:"center",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}} onClick={()=>{if(loading==false){login()}}}>{loading&&<Loader className="loading"  size={20} color="white"/>}{loading==false?"Login":"Loading..."}</div>
                <div style={{marginTop:"10px",fontSize:"14px"}}>Forgot Password? <Link style={{color:"orangered",textDecoration:"none",fontFamily:"poppins-light"}} onClick={()=>{set_show_token_email(true)}}>Recover</Link></div>
                ...
                <div style={{width:"90%",marginTop:"20px",marginBottom:"200px",display:"flex",flexDirection:"row",alignItems:"start",justifyContent:"space-between"}}>
                    <div style={{width:"49%",fontSize:"15px",paddingTop:"20px",paddingBottom:"20px",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",borderRadius:"6px",backgroundColor:"rgb(230,230,230)"}}>
                        <FcGoogle size={30}/>
                        <div>Google</div>
                    </div>
                    <div style={{width:"49%",fontSize:"15px",paddingTop:"20px",paddingBottom:"20px",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",borderRadius:"6px",backgroundColor:"rgb(230,230,230)"}}>
