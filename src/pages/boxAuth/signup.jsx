            ...
            <div style={{width:"100%",height:"90%",overflow:"scroll",borderRadius:"10px",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"start"}}>
                ...
                <div style={{width:"90%",marginTop:"20px",marginBottom:"20px",backgroundColor:"white",display:"flex",flexDirection:"column",alignItems:"start"}}>
                    ...
                    <div style={{width:"100%",backgroundColor:"white",border:"1px solid rgb(240,240,240)",borderRadius:"10px",paddingRight:"10px",boxSizing:"border-box",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
                        ...
                        }} placeholder="*****" style={{width:"90%",border:"0px"}}/>
                ...
                <div style={{width:"90%",backgroundColor:"#fd7e14",borderRadius:"10px",color:"white",paddingTop:"20px",paddingBottom:"20px",marginBottom:"20px",textAlign:"center",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}} onClick={async()=>{if(loading==false){await register()}}}>{loading&&<Loader className="loading"  size={20} color="white"/>}{loading==false?"Create Account":"Loading..."}</div>
