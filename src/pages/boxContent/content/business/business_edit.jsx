...
//https://backend-sbs.nellalink.com/public/api/v1/nellalink/smart-meta-manager/entity/nellalink_business/${business_uuid}
    ...
    return (
        <div style={{width:"100%",height:"100%",fontSize:"12px",backgroundColor:"rgba(255,255,255,0.3)",backdropFilter:"blur(10px)",position:"absolute",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"start"}}>
            ...
            <div className="box_card" style={{width:"80%",height:"100%",color:"rgb(100,100,100)",backgroundColor:"white",paddingLeft:"20px",paddingRight:"20px",boxSizing:"border-box",borderRadius:"0px",overflow:"scroll",display:"flex",flexDirection:"column",alignItems:"center"}}>
