...
function Menu(){
    ...
    const get_all_menu_url = `${import.meta.env.VITE_CORE_BACKEND_BASE_API_URL}/public/api/v1/nellalink/smart-meta-manager/entity/nellalink_business_menu?owned_by=${localStorage.getItem("uuid")}&page=1&parent_entity_type=&parent_entity_uuid=&per_page=20000000&sort_by=uuid&sort_order=asc`;
...
//https://backend-sbs.nellalink.com/public/api/v1/nellalink/smart-meta-manager/entity/nellalink_business_menu?owned_by=6a622d6e-b707-4159-9742-1ad91d4cc620&parent_entity_type=nellalink_business
    const get_business_url = `${import.meta.env.VITE_CORE_BACKEND_BASE_API_URL}/public/api/v1/nellalink/smart-meta-manager/entity/nellalink_business?owned_by=${localStorage.getItem("uuid")}&page=1&parent_entity_type=&parent_entity_uuid=&per_page=20000000&sort_by=uuid&sort_order=asc`;
        ...
        <div style={{width:"100%",height:"100%",fontSize:"12px",overflow:"scroll",display:"flex",flexDirection:"column",alignItems:"center",position:"relative",color:"black"}}>
          <div className="bus_header" style={{width:"90%",transition:"all 0.3s linear",display:"flex"}}>
            <div className="menu_header1" style={{fontSize:"14px",transition:"all 0.3s linear",paddingLeft:"10px",color:"white",display:"flex",alignItems:"center",justifyContent:"start",backgroundColor:"#fd7e14",borderRadius:"10px"}} onClick={()=>{
                ...
                set_i(null);
            }}><FaPlus size={14}/><div style={{paddingLeft:"3%"}}>Add Menu</div></div>
            ...
            {/* <div style={{width:"90%",marginTop:"20px",paddingTop:"20px",paddingBottom:"20px",display:"flex",flexDirection:"column",alignItems:"center",boxShadow:"-3px 3px 3px gray",borderRadius:"10px"}}>
             ...
             <div className="bus_body" style={{width:"100%",paddingTop:"40px",paddingBottom:"40px",position:"relative",display:"flex",flexDirection:"column",alignItems:"center",overflow:"scroll"}} onScroll={(e)=>{
            ...
            <div style={{width:"90%",fontFamily:"poppins-bold",backgroundColor:"#fd7d143a",paddingTop:"10px",paddingBottom:"10px",position:"relative",cursor:"grab",transition:"all 0.1s linear",marginTop:"0px",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",borderRadius:"0px",borderBottom:"1px solid rgb(220,220,220)"}}>
                <div className="menu_th" style={{textAlign:"center"}}>S/N</div>
                <div className="menu_small_table_header" style={{overflow:"scroll",flexDirection:"row",alignItems:"center",justifyContent:"start"}}>Menu Name</div>
                <div className="menu_large_table_header" style={{overflow:"scroll",flexDirection:"row",alignItems:"center",justifyContent:"start"}}>Email</div>
                <div className="menu_large_table_header" style={{overflow:"scroll",flexDirection:"row",alignItems:"center",justifyContent:"start"}}>Description</div>
                <div className="menu_small_table_header" style={{overflow:"scroll",flexDirection:"row",alignItems:"center",justifyContent:"start"}}>View</div>
                <div className="menu_th" style={{textAlign:"center",overflow:"scroll"}}>Actions</div>
            </div>
            {/* {
            ...
            } */}
            {
                Object.entries(
                    ...
                    return(
                    <div key={parentId} style={{width:"90%",position:"relative",borderRadius:"10px",marginTop:"20px",position:"relative",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
                        <div style={{width:"100%",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
                        <div style={{color:"#fd7e14",fontFamily:"poppins-light",fontSize:"12px"}}>{/*"parentId"*/}Category {index+1}</div>
                        <div style={{color:"orange",fontSize:"12px",fontFamily:"poppins-light",textDecoration:"underline",cursor:"pointer",display:"flex",alignItems:"center"}} onClick={()=>{
                            set_p_i(parentId);
                       ...
                       
                        {
                            items.map((item,index)=>{
                                ...
                                return(
                                    ...
                                    // ---------------(full list) (START)-----------------
                                // ------------item start ------------------------
                                <div key={index} style={{width:"100%",userSelect:"text",paddingTop:"10px",paddingBottom:"10px",fontSize:"12px",position:"relative",cursor:"grab",transition:"all 0.1s linear",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",borderRadius:"10px",borderRadius:"0px",backgroundColor:en==parentId&&i==index?"rgb(100,100,100,1)":"white",color:en==parentId&&i==index?"white":"rgb(30,30,30)",borderBottom:"1px solid rgb(220,220,220)"}} draggable
                                     onDragStart={(e)=>{
            ...
            await fetch(`${import.meta.env.VITE_CORE_BACKEND_BASE_API_URL}/public/api/v1/nellalink/smart-meta-manager/entity/nellalink_business?owned_by=${localStorage.getItem("uuid")}&page=1&parent_entity_type=&parent_entity_uuid=&per_page=${1000000}&sort_by=uuid&sort_order=asc`,{
                ...
                console.log("SORRY",err);
                            ...
                            <div className="menu_th" style={{textAlign:"center",fontSize:"14px",fontWeight:"bolder"}}>
                                <FaEllipsisVertical size={20} color={en==parentId&&i==index?"white":"rgb(100,100,100)"} style={{cursor:"pointer"}} onClick={()=>{
                        ...
                        {/* -----------------------------pop start full list----------------------------- */}
{
                            ...
                            <div style={{paddingLeft:"10px",paddingRight:"10px",zIndex:"10",fontSize:"12px",position:"absolute",backgroundColor:"white",borderRadius:"4px",boxShadow:"0px 0px 10px rgb(220,220,220)",paddingLeft:"10px",paddingRight:"10px",top:"20%",right:"20%",display:"flex",flexDirection:"row",alignItems:"end",justifyContent:"start"}}>
                                <div style={{width:"100%",height:"100%",paddingLeft:"10px",paddingRight:"10px",display:"grid",gap:"0px",gridTemplateColumns:"repeat(1,1fr)",flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
                                    <div className="view" style={{width:"100%",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"start",color:"rgb(30,30,30)",backgroundColor:"rgba(0,0,0,0)"}} onClick={async()=>{
            await fetch(`${import.meta.env.VITE_CORE_BACKEND_BASE_API_URL}/public/api/v1/nellalink/smart-meta-manager/entity/nellalink_business?owned_by=${localStorage.getItem("uuid")}&page=1&parent_entity_type=&parent_entity_uuid=&per_page=${1000000}&sort_by=uuid&sort_order=asc`,{
                method: "get",
                headers:{
                    "Content-Type": "application/json",
            ...
            await fetch(`${import.meta.env.VITE_CORE_BACKEND_BASE_API_URL}/public/api/v1/nellalink/smart-meta-manager/entity/nellalink_business?owned_by=${localStorage.getItem("uuid")}&page=1&parent_entity_type=&parent_entity_uuid=&per_page=${1000000}&sort_by=uuid&sort_order=asc`,{
                ...
                console.log("SORRY",err);
                    ...
                    {/* -------------item end ...MOVE THE "tr" below  (full list)-------------------- */}
                    </div>
                    ...
                    // ---------------(full list) (END)-----------------
                            ...
                            // ---------------------------------PREVIEW-----------------------------
                                ...
                                return(
                                    ...
                                    // ---------------(preview) (START)-----------------
                                // ------------item start ------------------------
                                <div key={index} style={{width:"100%",userSelect:"text",paddingTop:"10px",paddingBottom:"10px",fontSize:"12px",position:"relative",cursor:"grab",transition:"all 0.1s linear",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",borderRadius:"10px",borderRadius:"0px",backgroundColor:en==parentId&&i==index?"rgb(100,100,100)":"white",color:en==parentId&&i==index?"white":"rgb(30,30,30)",borderBottom:"1px solid rgb(220,220,220)"}} draggable
                                     onDragStart={(e)=>{
                                        set_drag({parentId,index});
                                        e.target.style.opacity="0";
                                    }} onDrop={(e)=>{
                        ...
                        {/* -----------------------------pop start preview----------------------------- */}
{
            ...
            await fetch(`${import.meta.env.VITE_CORE_BACKEND_BASE_API_URL}/public/api/v1/nellalink/smart-meta-manager/entity/nellalink_business?owned_by=${localStorage.getItem("uuid")}&page=1&parent_entity_type=&parent_entity_uuid=&per_page=${1000000}&sort_by=uuid&sort_order=asc`,{
                ...
                console.log("SORRY",err);
                    ...
                    {/* -------------item end ...MOVE THE "tr" below  (preview)-------------------- */}
                    </div>
...
// --------------------------------------GGGGGGGGGGOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
