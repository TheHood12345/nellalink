            ...
            <div style={{width:"100%",display:"flex",flexDirection:"column",alignItems:"center"}}>
                ...
                <div style={{width:"100%",display:"flex",border:"1px solid rgb(240,240,240)",borderRadius:"10px",flexDirection:"row",alignItems:"center",justifyContent:"center"}}>
                    <div style={{width:"90%",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
                        <FaLock/>
                        <input type="text" value={ver_tok} placeholder="******" style={{width:"80%",border:"0px"}} onChange={(e)=>{
                ...
                <div style={{width:"100%",display:"flex",flexDirection:"row",justifyContent:"end",alignItems:"center"}}>
                    <div style={{display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",color:"orange",borderRadius:"10px",fontSize:"12px",width:"40%",paddingTop:"10px",paddingBottom:"10px",marginTop:"10px",cursor:"pointer"}} onClick={async()=>{
